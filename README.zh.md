...
## 加入社群
如果你觉得 Skill Forge 对你有帮助，并希望：
*   与我进行更深入的交流，探讨 AI Agent 和 Claude Skills 的更多玩法；
*   获取关于大模型应用的独家内容、实战案例和源码解读；
*   结识一群同样走在 AI 应用探索前沿的伙伴；
欢迎加入我的知识星球【威廉的 AI Club】，与数百位走在 AI 应用探索前沿的伙伴们一起，用 AI 点燃心火。

<img src="github-assets/zsxq_qrcode.JPG" alt="威廉的 AI Club 知识星球" width="400"/>
